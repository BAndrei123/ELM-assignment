...
var $author$project$Model$PostIds$advance = function (_v0) {
	...
	if (_v1.$ === 'Just') {
		var newCurssor = _v1.a;
		return $elm$core$Maybe$Just(
			_Utils_Tuple2(
				$author$project$Cursor$current(newCurssor),
				$author$project$Model$PostIds$PostIds(newCurssor)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Model$PostsConfig$applyChanges = F2(
	function (change, postsConfig) {
		switch (change.$) {
			case 'ChangedPostsToFetch':
				var value = change.a;
				return _Utils_update(
					postsConfig,
					{postsToFetch: value});
			case 'PostsToShowChanged':
				var value = change.a;
				return _Utils_update(
					postsConfig,
					{postsToShow: value});
...
var $author$project$Model$PostIds$decode = A2(
	...
	function (ids) {
		return $elm$json$Json$Decode$succeed(
			$author$project$Model$PostIds$fromList(ids));
	},
...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		var tp = $elm$time$Time$posixToMillis(t2) - $elm$time$Time$posixToMillis(t1);
		var diffMillis = $elm$time$Time$posixToMillis(t2) - $elm$time$Time$posixToMillis(t1);
		var hours = A2($elm$core$Basics$modBy, 24, (diffMillis / ((1000 * 60) * 60)) | 0);
		var minutes = A2($elm$core$Basics$modBy, 60, (diffMillis / (1000 * 60)) | 0);
		var seconds = A2($elm$core$Basics$modBy, 60, (diffMillis / 1000) | 0);
		var days = (diffMillis / (((1000 * 60) * 60) * 24)) | 0;
		var myDuration = $elm$core$Maybe$Just(
			{days: days, hours: hours, minutes: minutes, seconds: seconds});
		return (tp <= 0) ? $elm$core$Maybe$Nothing : myDuration;
	});
var $author$project$Util$Time$formatDuration = function (d) {
	var seconds = (d.seconds === 1) ? ($elm$core$String$fromInt(d.seconds) + ' second ago') : ((d.seconds > 1) ? ($elm$core$String$fromInt(d.seconds) + ' seconds ago') : '');
	var minutes = ((d.minutes === 1) && (!d.seconds)) ? ($elm$core$String$fromInt(d.minutes) + ' minute ago') : ((d.minutes === 1) ? ($elm$core$String$fromInt(d.minutes) + ' minute ') : (((d.minutes > 1) && (!d.seconds)) ? ($elm$core$String$fromInt(d.minutes) + ' minutes ago') : ((d.minutes > 1) ? ($elm$core$String$fromInt(d.minutes) + ' minutes ') : '')));
	var hours = ((d.hours === 1) && ((!d.seconds) && (!d.hours))) ? ($elm$core$String$fromInt(d.hours) + ' hour ago') : (((d.hours === 1) && ((!(!d.minutes)) || (!(!d.seconds)))) ? ($elm$core$String$fromInt(d.hours) + ' hour ') : (((d.hours > 1) && ((!d.seconds) && (!d.minutes))) ? ($elm$core$String$fromInt(d.hours) + ' hours ago') : (((d.hours > 1) && ((!(!d.minutes)) || (!(!d.seconds)))) ? ($elm$core$String$fromInt(d.hours) + ' hours ') : '')));
	var days = ((d.days === 1) && ((!d.hours) && ((!d.minutes) && (!d.seconds)))) ? ($elm$core$String$fromInt(d.days) + ' day ago') : (((d.days === 1) && ((!(!d.hours)) || ((!(!d.minutes)) || (!(!d.seconds))))) ? ($elm$core$String$fromInt(d.days) + ' day ') : (((d.days > 1) && ((!d.hours) && ((!d.minutes) && (!d.seconds)))) ? ($elm$core$String$fromInt(d.days) + ' days ago') : (((d.days > 1) && ((!(!d.hours)) || ((!(!d.minutes)) || (!(!d.seconds))))) ? ($elm$core$String$fromInt(d.days) + ' days ') : '')));
	var time = _Utils_ap(
		days,
		_Utils_ap(
			hours,
			_Utils_ap(minutes, seconds)));
	return time;
};
...
var $author$project$View$Posts$postToHtml = F2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($author$project$Util$Time$formatTime, $elm$time$Time$utc, post.time) + (' (' + ($author$project$Util$Time$formatDuration(
								A2(
									$elm$core$Maybe$withDefault,
...
var $author$project$Model$PostsConfig$ChangedSortBy = function (a) {
	return {$: 'ChangedSortBy', a: a};
};
var $author$project$Model$PostsConfig$ChangedshowJobs = function (a) {
	return {$: 'ChangedshowJobs', a: a};
};
...
var $author$project$Model$PostsConfig$sortFromString = function (string) {
	switch (string) {
		case 'Score':
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\ExampleTests\\CursorTests.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\ExampleTests\\ModelPostIdsTests.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\ExampleTests\\ModelPostsConfigTests.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\ExampleTests\\UtilTimeTests.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\MainTests.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\PostsConfigTests.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\PostsViewTests.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\PostTests.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\SimulatedEffect.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\TestData.elm', 'C:\\Users\\Tudor\\Desktop\\Elm-Project (1)\\tests\\TestUtils.elm']),
		processes: 8,
